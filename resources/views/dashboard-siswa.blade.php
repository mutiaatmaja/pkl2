...
@section('content')
    ...
    <div class="space-y-6">
        <div>
            ...
            <h1 class="mt-1 text-2xl font-extrabold tracking-tight text-slate-900">Dashboard Siswa</h1>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div class="mt-4 flex flex-wrap gap-2">
                <a href="{{ route('siswa.pilih-dudi') }}" wire:navigate
                    class="inline-flex items-center rounded-xl bg-cyan-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-cyan-700">
                    Pilih / Ganti DUDI
                </a>
